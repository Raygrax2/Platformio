...
// Si prefieres usar memset en lugar de la inicialización = {}, descomenta la siguiente línea:
// #include <string.h>
...
void SimpleI2C::setup(uint8_t device_address, uint32_t freq, uint8_t sda_pin, uint8_t scl_pin, i2c_port_t i2c_num)
{
    if (!_i2c_initialized)
    {
        // Inicialización segura en C++ (pone todos los campos a cero)
        i2c_master_bus_config_t conf = {};

#ifdef I2C_CLK_SRC_RC_FAST
